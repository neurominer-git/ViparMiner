...
if ( !defined($config->get("stats_r")) &&  !defined($config->get("stats_stata")) && !defined($config->get("stats_sas")) )
{
...
#			 	 my $temp = threads->create(\&exec_stats,$fpath,$stats,$project,$workingdir,$project_dir,$errorfile,$batchcode,$tag);
#				 my $temp = threads->create(\&exec_stats,$stats,$project,$workingdir,$project_dir,$errorfile,$batchcode,$tag);
#				 $temp->detach();
